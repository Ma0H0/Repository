...
public class EmpDeptSalgradeTests
{
    ...
    public void ShouldReturnEmployeesFromChicago()
    {
        ...
        var resultDept = depts.Where(d => d.Loc == "CHICAGO").Select(d => d.DeptNo); 

        List<Emp> result = emps.Where(e => resultDept.Contains(e.DeptNo)).ToList();
    ...
    public void ShouldReturnEmployeesEarningMoreThanDeptAverage()
    {
        ...
        var result = emps.Where(e => e.Sal > emps.Where(inner => inner.DeptNo == e.DeptNo)
